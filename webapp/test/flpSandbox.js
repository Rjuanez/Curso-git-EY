			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"helloworld-display": {
								"semanticObject": "helloworld",
								"action": "display",
								"description": "A Hello World SAP Fiori application.",
								"title": "HelloWorld",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=helloworld",
									"url": sap.ui.require.toUrl("helloworld")
								}
							}
						}
					}
